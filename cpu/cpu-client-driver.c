...
DEF_FN(CUresult, cuVDPAUCtxCreate, CUcontext *, pCtx, unsigned int, flags,
       CUdevice, device, VdpDevice, vdpDevice, VdpGetProcAddress *,
       vdpGetProcAddress)
DEF_FN(CUresult, cuGraphicsVDPAURegisterVideoSurface, CUgraphicsResource *,
                        ...
                        int numParams, unsigned int flags, CUdevice dev)
{
    ...
    mem_data params = { .mem_data_len = sizeof(CUexecAffinityParam) * numParams,
                        .mem_data_val = (void *)paramsArray };
    LOGE(LOG_DEBUG, "%s(%p, %p, %d, %u, %d)", __FUNCTION__, pctx, paramsArray,
         numParams, flags, dev);
    retval_1 =
        rpc_cuctxcreate_v3_1(params, numParams, flags, (ptr)dev, &result, clnt);
...
DEF_FN(CUresult, cuModuleGetGlobal, CUdeviceptr *, dptr, size_t *, bytes,
...
CUresult cuMemAlloc(CUdeviceptr *dptr, size_t bytesize)
{
    ...
    *dptr = result.ptr_result_u.ptr;
    // printf("post %s(%p->%p, %lu) = %d\n", __FUNCTION__, dptr, *dptr,
    // bytesize, ret);
    return result.err;
}

#undef cuMemAllocPitch
DEF_FN(CUresult, cuMemAllocPitch, CUdeviceptr *, dptr, size_t *, pPitch, size_t,
...
DEF_FN(CUresult, cuMemHostRegister, void *, p, size_t, bytesize, unsigned int,
       Flags)
#undef cuMemsetD8
DEF_FN(CUresult, cuMemsetD8, CUdeviceptr, dstDevice, unsigned char, uc, size_t,
       N);
DEF_FN(CUresult, cuMemsetD8_v2_ptds, CUdeviceptr, dstDevice, unsigned char, uc,
       size_t, N);
#undef cuMemsetD2D8
DEF_FN(CUresult, cuMemsetD2D8, CUdeviceptr, dstDevice, size_t, dstPitch,
       unsigned char, uc, size_t, Width, size_t, Height)
DEF_FN(CUresult, cuMemsetD2D8_v2_ptds, CUdeviceptr, dstDevice, size_t, dstPitch,
       unsigned char, uc, size_t, Width, size_t, Height)
...
#undef cuGLCtxCreate
DEF_FN(CUresult, cuGLCtxCreate, CUcontext *, pCtx, unsigned int, Flags,
       CUdevice, device)
#undef cuArrayCreate
DEF_FN(CUresult, cuArrayCreate, CUarray *, pHandle,
       const CUDA_ARRAY_DESCRIPTOR *, pAllocateArray)
#undef cuArrayGetDescriptor
DEF_FN(CUresult, cuArrayGetDescriptor, CUDA_ARRAY_DESCRIPTOR *,
       pArrayDescriptor, CUarray, hArray)
#undef cuArray3DCreate
DEF_FN(CUresult, cuArray3DCreate, CUarray *, pHandle,
       const CUDA_ARRAY3D_DESCRIPTOR *, pAllocateArray)
#undef cuArray3DGetDescriptor
DEF_FN(CUresult, cuArray3DGetDescriptor, CUDA_ARRAY3D_DESCRIPTOR *,
       pArrayDescriptor, CUarray, hArray)
#undef cuTexRefSetAddress2D
DEF_FN(CUresult, cuTexRefSetAddress2D, CUtexref, hTexRef,
...
DEF_FN(CUresult, cuGLGetDevices, unsigned int *, pCudaDeviceCount, CUdevice *,
       pCudaDevices, unsigned int, cudaDeviceCount, CUGLDeviceList, deviceList)
DEF_FN(CUresult, cuGLRegisterBufferObject, GLuint, buffer)
DEF_FN(CUresult, cuGLMapBufferObject_v2, CUdeviceptr *, dptr, size_t *, size,
       GLuint, buffer)
DEF_FN(CUresult, cuGLMapBufferObject_v2_ptds, CUdeviceptr *, dptr, size_t *,
       size, GLuint, buffer)
DEF_FN(CUresult, cuGLMapBufferObjectAsync_v2, CUdeviceptr *, dptr, size_t *,
       size, GLuint, buffer, CUstream, hStream)
DEF_FN(CUresult, cuGLMapBufferObjectAsync_v2_ptsz, CUdeviceptr *, dptr,
       size_t *, size, GLuint, buffer, CUstream, hStream)
...
DEF_FN(CUresult, cuGLSetBufferObjectMapFlags, GLuint, buffer, unsigned int,
       Flags)
DEF_FN(CUresult, cuGraphicsGLRegisterImage, CUgraphicsResource *, pCudaResource,
       GLuint, image, GLenum, target, unsigned int, Flags)
DEF_FN(CUresult, cuGraphicsGLRegisterBuffer, CUgraphicsResource *,
       pCudaResource, GLuint, buffer, unsigned int, Flags)
DEF_FN(CUresult, cuGraphicsEGLRegisterImage, CUgraphicsResource *,
       pCudaResource, EGLImageKHR, image, unsigned int, flags)
DEF_FN(CUresult, cuEGLStreamConsumerConnect, CUeglStreamConnection *, conn,
       EGLStreamKHR, stream)
DEF_FN(CUresult, cuEGLStreamConsumerDisconnect, CUeglStreamConnection *, conn)
DEF_FN(CUresult, cuEGLStreamConsumerAcquireFrame, CUeglStreamConnection *, conn,
       CUgraphicsResource *, pCudaResource, CUstream *, pStream, unsigned int,
       timeout)
DEF_FN(CUresult, cuEGLStreamConsumerReleaseFrame, CUeglStreamConnection *, conn,
       CUgraphicsResource, pCudaResource, CUstream *, pStream)
DEF_FN(CUresult, cuEGLStreamProducerConnect, CUeglStreamConnection *, conn,
       EGLStreamKHR, stream, EGLint, width, EGLint, height)
DEF_FN(CUresult, cuEGLStreamProducerDisconnect, CUeglStreamConnection *, conn)
DEF_FN(CUresult, cuEGLStreamProducerPresentFrame, CUeglStreamConnection *, conn,
       CUeglFrame, eglframe, CUstream *, pStream)
DEF_FN(CUresult, cuEGLStreamProducerReturnFrame, CUeglStreamConnection *, conn,
       CUeglFrame *, eglframe, CUstream *, pStream)
DEF_FN(CUresult, cuGraphicsResourceGetMappedEglFrame, CUeglFrame *, eglFrame,
       CUgraphicsResource, resource, unsigned int, index, unsigned int,
       mipLevel)
...
DEF_FN(CUresult, cuDeviceGetLuid, char *, luid, unsigned int *, deviceNodeMask,
       CUdevice, dev)
...
CUresult cuDeviceGetAttribute(int *pi, CUdevice_attribute attrib, CUdevice dev)
{
    ...
    LOGE(LOG_DEBUG, "[rpc] %s(%d, %d) = %d, result %d", __FUNCTION__, attrib,
         dev, result.err, result.int_result_u.data);
    if (retval != RPC_SUCCESS) {
        fprintf(stderr, "[rpc] %s failed.", __FUNCTION__);
        return CUDA_ERROR_UNKNOWN;
    }
...
CUresult cuDeviceGetProperties(CUdevprop *prop, CUdevice dev)
{
    ...
    if (memcpy(prop, result.mem_result_u.data.mem_data_val,
               sizeof(CUdevprop)) == NULL) {
                                 ...
                                 CUdevice srcDevice, CUdevice dstDevice)
{
    enum clnt_stat retval;
    int_result result;
    retval = rpc_cudevicegetp2pattribute_1((int)attrib, (ptr)srcDevice,
                                           (ptr)dstDevice, &result, clnt);
    LOGE(LOG_DEBUG, "[rpc] %s(%d, %p, %p) = %d, result %s", __FUNCTION__,
         attrib, srcDevice, dstDevice, result.err, result.int_result_u.data);
    if (retval != RPC_SUCCESS) {
        fprintf(stderr, "[rpc] %s failed.", __FUNCTION__);
        return CUDA_ERROR_UNKNOWN;
    }
...
DEF_FN(CUresult, cuCtxGetStreamPriorityRange, int *, leastPriority, int *,
       greatestPriority)
...
CUresult cuModuleLoadData(CUmodule *module, const void *image)
{
    ...
    if (elf2_parameter_info(&kernel_infos, mem.mem_data_val,
                            mem.mem_data_len) != 0) {
...
DEF_FN(CUresult, cuModuleGetTexRef, CUtexref *, pTexRef, CUmodule, hmod,
       const char *, name)
DEF_FN(CUresult, cuModuleGetSurfRef, CUsurfref *, pSurfRef, CUmodule, hmod,
       const char *, name)
#undef cuLinkCreate
DEF_FN(CUresult, cuLinkCreate, unsigned int, numOptions, CUjit_option *,
       options, void **, optionValues, CUlinkState *, stateOut)
#undef cuLinkAddData
DEF_FN(CUresult, cuLinkAddData, CUlinkState, state, CUjitInputType, type,
       void *, data, size_t, size, const char *, name, unsigned int, numOptions,
       CUjit_option *, options, void **, optionValues)
#undef cuLinkAddFile
DEF_FN(CUresult, cuLinkAddFile, CUlinkState, state, CUjitInputType, type,
       const char *, path, unsigned int, numOptions, CUjit_option *, options,
       void **, optionValues)
DEF_FN(CUresult, cuLinkComplete, CUlinkState, state, void **, cubinOut,
       size_t *, sizeOut)
DEF_FN(CUresult, cuLinkDestroy, CUlinkState, state)
DEF_FN(CUresult, cuMemAllocManaged, CUdeviceptr *, dptr, size_t, bytesize,
       unsigned int, flags)
DEF_FN(CUresult, cuMemFreeHost, void *, p)
DEF_FN(CUresult, cuMemHostAlloc, void **, pp, size_t, bytesize, unsigned int,
       Flags)
...
DEF_FN(CUresult, cuMemcpy, CUdeviceptr, dst, CUdeviceptr, src, size_t,
       ByteCount)
DEF_FN(CUresult, cuMemcpy_ptds, CUdeviceptr, dst, CUdeviceptr, src, size_t,
       ByteCount)
// DEF_FN(CUresult, cuMemcpyHtoD, CUdeviceptr, dstDevice, const void*, srcHost,
// size_t, ByteCount)
#undef cuMemcpyHtoD
...
DEF_FN(CUresult, cuMemcpyHtoD_v2_ptds, CUdeviceptr, dstDevice, const void *,
       srcHost, size_t, ByteCount)
#undef cuMemcpyDtoH
DEF_FN(CUresult, cuMemcpyDtoH, void *, dstHost, CUdeviceptr, srcDevice, size_t,
       ByteCount)
DEF_FN(CUresult, cuMemcpyDtoH_v2_ptds, void *, dstHost, CUdeviceptr, srcDevice,
       size_t, ByteCount)
#undef cuMemcpyDtoD
DEF_FN(CUresult, cuMemcpyDtoD, CUdeviceptr, dstDevice, CUdeviceptr, srcDevice,
       size_t, ByteCount)
DEF_FN(CUresult, cuMemcpyDtoD_v2_ptds, CUdeviceptr, dstDevice, CUdeviceptr,
       srcDevice, size_t, ByteCount)
#undef cuMemcpyDtoA
DEF_FN(CUresult, cuMemcpyDtoA, CUarray, dstArray, size_t, dstOffset,
       CUdeviceptr, srcDevice, size_t, ByteCount)
#undef cuMemcpyAtoD
DEF_FN(CUresult, cuMemcpyAtoD, CUdeviceptr, dstDevice, CUarray, srcArray,
       size_t, srcOffset, size_t, ByteCount)
#undef cuMemcpyHtoA
DEF_FN(CUresult, cuMemcpyHtoA, CUarray, dstArray, size_t, dstOffset,
       const void *, srcHost, size_t, ByteCount)
#undef cuMemcpyAtoH
DEF_FN(CUresult, cuMemcpyAtoH, void *, dstHost, CUarray, srcArray, size_t,
       srcOffset, size_t, ByteCount)
#undef cuMemcpyAtoA
DEF_FN(CUresult, cuMemcpyAtoA, CUarray, dstArray, size_t, dstOffset, CUarray,
...
DEF_FN(CUresult, cuMemcpyPeerAsync, CUdeviceptr, dstDevice, CUcontext,
       dstContext, CUdeviceptr, srcDevice, CUcontext, srcContext, size_t,
       ByteCount, CUstream, hStream)
DEF_FN(CUresult, cuMemcpyPeerAsync_ptsz, CUdeviceptr, dstDevice, CUcontext,
       dstContext, CUdeviceptr, srcDevice, CUcontext, srcContext, size_t,
       ByteCount, CUstream, hStream)
#undef cuMemcpyHtoAAsync
DEF_FN(CUresult, cuMemcpyHtoAAsync, CUarray, dstArray, size_t, dstOffset,
       const void *, srcHost, size_t, ByteCount, CUstream, hStream)
#undef cuMemcpyAtoHAsync
DEF_FN(CUresult, cuMemcpyAtoHAsync, void *, dstHost, CUarray, srcArray, size_t,
       srcOffset, size_t, ByteCount, CUstream, hStream)
DEF_FN(CUresult, cuMemcpy3DPeerAsync, const CUDA_MEMCPY3D_PEER *, pCopy,
       CUstream, hStream)
DEF_FN(CUresult, cuMemcpy3DPeerAsync_ptsz, const CUDA_MEMCPY3D_PEER *, pCopy,
       CUstream, hStream)
#undef cuMemcpyHtoDAsync
DEF_FN(CUresult, cuMemcpyHtoDAsync, CUdeviceptr, dstDevice, const void *,
       srcHost, size_t, ByteCount, CUstream, hStream)
DEF_FN(CUresult, cuMemcpyHtoDAsync_v2_ptsz, CUdeviceptr, dstDevice,
       const void *, srcHost, size_t, ByteCount, CUstream, hStream)
#undef cuMemcpyDtoHAsync
DEF_FN(CUresult, cuMemcpyDtoHAsync, void *, dstHost, CUdeviceptr, srcDevice,
       size_t, ByteCount, CUstream, hStream)
DEF_FN(CUresult, cuMemcpyDtoHAsync_v2_ptsz, void *, dstHost, CUdeviceptr,
       srcDevice, size_t, ByteCount, CUstream, hStream)
#undef cuMemcpyDtoDAsync
DEF_FN(CUresult, cuMemcpyDtoDAsync, CUdeviceptr, dstDevice, CUdeviceptr,
       srcDevice, size_t, ByteCount, CUstream, hStream)
DEF_FN(CUresult, cuMemcpyDtoDAsync_v2_ptsz, CUdeviceptr, dstDevice, CUdeviceptr,
       srcDevice, size_t, ByteCount, CUstream, hStream)
#undef cuMemcpy2DAsync
DEF_FN(CUresult, cuMemcpy2DAsync, const CUDA_MEMCPY2D *, pCopy, CUstream,
       hStream)
DEF_FN(CUresult, cuMemcpy2DAsync_v2_ptsz, const CUDA_MEMCPY2D *, pCopy,
       CUstream, hStream)
#undef cuMemcpy3DAsync
DEF_FN(CUresult, cuMemcpy3DAsync, const CUDA_MEMCPY3D *, pCopy, CUstream,
       hStream)
DEF_FN(CUresult, cuMemcpy3DAsync_v2_ptsz, const CUDA_MEMCPY3D *, pCopy,
       CUstream, hStream)
DEF_FN(CUresult, cuMemcpyAsync, CUdeviceptr, dst, CUdeviceptr, src, size_t,
       ByteCount, CUstream, hStream)
DEF_FN(CUresult, cuMemcpyAsync_ptsz, CUdeviceptr, dst, CUdeviceptr, src, size_t,
       ByteCount, CUstream, hStream)
DEF_FN(CUresult, cuMemcpyPeer, CUdeviceptr, dstDevice, CUcontext, dstContext,
       CUdeviceptr, srcDevice, CUcontext, srcContext, size_t, ByteCount)
DEF_FN(CUresult, cuMemcpyPeer_ptds, CUdeviceptr, dstDevice, CUcontext,
       dstContext, CUdeviceptr, srcDevice, CUcontext, srcContext, size_t,
       ByteCount)
...
DEF_FN(CUresult, cuMemsetD8Async, CUdeviceptr, dstDevice, unsigned char, uc,
       size_t, N, CUstream, hStream)
DEF_FN(CUresult, cuMemsetD8Async_ptsz, CUdeviceptr, dstDevice, unsigned char,
       uc, size_t, N, CUstream, hStream)
DEF_FN(CUresult, cuMemsetD2D8Async, CUdeviceptr, dstDevice, size_t, dstPitch,
       unsigned char, uc, size_t, Width, size_t, Height, CUstream, hStream)
DEF_FN(CUresult, cuMemsetD2D8Async_ptsz, CUdeviceptr, dstDevice, size_t,
       dstPitch, unsigned char, uc, size_t, Width, size_t, Height, CUstream,
       hStream)
...
DEF_FN(CUresult, cuMipmappedArrayCreate, CUmipmappedArray *, pHandle,
       const CUDA_ARRAY3D_DESCRIPTOR *, pMipmappedArrayDesc, unsigned int,
       numMipmapLevels)
DEF_FN(CUresult, cuMipmappedArrayGetLevel, CUarray *, pLevelArray,
...
DEF_FN(CUresult, cuTexRefSetArray, CUtexref, hTexRef, CUarray, hArray,
       unsigned int, Flags)
DEF_FN(CUresult, cuTexRefSetMipmappedArray, CUtexref, hTexRef, CUmipmappedArray,
       hMipmappedArray, unsigned int, Flags)
DEF_FN(CUresult, cuTexRefSetFormat, CUtexref, hTexRef, CUarray_format, fmt, int,
       NumPackedComponents)
DEF_FN(CUresult, cuTexRefSetAddressMode, CUtexref, hTexRef, int, dim,
       CUaddress_mode, am)
DEF_FN(CUresult, cuTexRefSetFilterMode, CUtexref, hTexRef, CUfilter_mode, fm)
DEF_FN(CUresult, cuTexRefSetMipmapFilterMode, CUtexref, hTexRef, CUfilter_mode,
       fm)
DEF_FN(CUresult, cuTexRefSetMipmapLevelBias, CUtexref, hTexRef, float, bias)
DEF_FN(CUresult, cuTexRefSetMipmapLevelClamp, CUtexref, hTexRef, float,
       minMipmapLevelClamp, float, maxMipmapLevelClamp)
DEF_FN(CUresult, cuTexRefSetMaxAnisotropy, CUtexref, hTexRef, unsigned int,
       maxAniso)
DEF_FN(CUresult, cuTexRefSetFlags, CUtexref, hTexRef, unsigned int, Flags)
DEF_FN(CUresult, cuTexRefSetBorderColor, CUtexref, hTexRef, float *,
       pBorderColor)
DEF_FN(CUresult, cuTexRefGetBorderColor, float *, pBorderColor, CUtexref,
       hTexRef)
DEF_FN(CUresult, cuSurfRefSetArray, CUsurfref, hSurfRef, CUarray, hArray,
       unsigned int, Flags)
DEF_FN(CUresult, cuTexObjectCreate, CUtexObject *, pTexObject,
       const CUDA_RESOURCE_DESC *, pResDesc, const CUDA_TEXTURE_DESC *,
       pTexDesc, const CUDA_RESOURCE_VIEW_DESC *, pResViewDesc)
DEF_FN(CUresult, cuTexObjectDestroy, CUtexObject, texObject)
DEF_FN(CUresult, cuTexObjectGetResourceDesc, CUDA_RESOURCE_DESC *, pResDesc,
       CUtexObject, texObject)
DEF_FN(CUresult, cuTexObjectGetTextureDesc, CUDA_TEXTURE_DESC *, pTexDesc,
       CUtexObject, texObject)
DEF_FN(CUresult, cuTexObjectGetResourceViewDesc, CUDA_RESOURCE_VIEW_DESC *,
       pResViewDesc, CUtexObject, texObject)
DEF_FN(CUresult, cuSurfObjectCreate, CUsurfObject *, pSurfObject,
       const CUDA_RESOURCE_DESC *, pResDesc)
DEF_FN(CUresult, cuSurfObjectDestroy, CUsurfObject, surfObject)
DEF_FN(CUresult, cuSurfObjectGetResourceDesc, CUDA_RESOURCE_DESC *, pResDesc,
       CUsurfObject, surfObject)
DEF_FN(CUresult, cuImportExternalMemory, CUexternalMemory *, extMem_out,
       const CUDA_EXTERNAL_MEMORY_HANDLE_DESC *, memHandleDesc)
DEF_FN(CUresult, cuExternalMemoryGetMappedBuffer, CUdeviceptr *, devPtr,
       CUexternalMemory, extMem, const CUDA_EXTERNAL_MEMORY_BUFFER_DESC *,
       bufferDesc)
DEF_FN(CUresult, cuExternalMemoryGetMappedMipmappedArray, CUmipmappedArray *,
       mipmap, CUexternalMemory, extMem,
...
DEF_FN(CUresult, cuImportExternalSemaphore, CUexternalSemaphore *, extSem_out,
       const CUDA_EXTERNAL_SEMAPHORE_HANDLE_DESC *, semHandleDesc)
DEF_FN(CUresult, cuSignalExternalSemaphoresAsync, const CUexternalSemaphore *,
       extSemArray, const CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS *, paramsArray,
       unsigned int, numExtSems, CUstream, stream)
DEF_FN(CUresult, cuSignalExternalSemaphoresAsync_ptsz,
       const CUexternalSemaphore *, extSemArray,
       const CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS *, paramsArray, unsigned int,
       numExtSems, CUstream, stream)
DEF_FN(CUresult, cuWaitExternalSemaphoresAsync, const CUexternalSemaphore *,
       extSemArray, const CUDA_EXTERNAL_SEMAPHORE_WAIT_PARAMS *, paramsArray,
       unsigned int, numExtSems, CUstream, stream)
DEF_FN(CUresult, cuWaitExternalSemaphoresAsync_ptsz,
       const CUexternalSemaphore *, extSemArray,
       const CUDA_EXTERNAL_SEMAPHORE_WAIT_PARAMS *, paramsArray, unsigned int,
       numExtSems, CUstream, stream)
DEF_FN(CUresult, cuDestroyExternalSemaphore, CUexternalSemaphore, extSem)
#undef cuLaunchKernel
// DEF_FN(CUresult, cuLaunchKernel, CUfunction, f, unsigned int, gridDimX,
// unsigned int, gridDimY, unsigned int, gridDimZ, unsigned int, blockDimX,
// unsigned int, blockDimY, unsigned int, blockDimZ, unsigned int,
                        ...
                        CUstream hStream, void **kernelParams, void **extra)
{
    ...
    retval =
        rpc_culaunchkernel_1((uint64_t)f, gridDimX, gridDimY, gridDimZ,
                             ...
                             (uint64_t)hStream, rpc_args, &result, clnt);
...
DEF_FN(CUresult, cuLaunchKernel_ptsz, CUfunction, f, unsigned int, gridDimX,
       unsigned int, gridDimY, unsigned int, gridDimZ, unsigned int, blockDimX,
       unsigned int, blockDimY, unsigned int, blockDimZ, unsigned int,
       sharedMemBytes, CUstream, hStream, void **, kernelParams, void **, extra)
#undef cuLaunchCooperativeKernel
DEF_FN(CUresult, cuLaunchCooperativeKernel, CUfunction, f, unsigned int,
       gridDimX, unsigned int, gridDimY, unsigned int, gridDimZ, unsigned int,
       blockDimX, unsigned int, blockDimY, unsigned int, blockDimZ,
       unsigned int, sharedMemBytes, CUstream, hStream, void **, kernelParams)
DEF_FN(CUresult, cuLaunchCooperativeKernel_ptsz, CUfunction, f, unsigned int,
       gridDimX, unsigned int, gridDimY, unsigned int, gridDimZ, unsigned int,
       blockDimX, unsigned int, blockDimY, unsigned int, blockDimZ,
       unsigned int, sharedMemBytes, CUstream, hStream, void **, kernelParams)
DEF_FN(CUresult, cuLaunchCooperativeKernelMultiDevice, CUDA_LAUNCH_PARAMS *,
       launchParamsList, unsigned int, numDevices, unsigned int, flags)
DEF_FN(CUresult, cuLaunchHostFunc, CUstream, hStream, CUhostFn, fn, void *,
       userData)
DEF_FN(CUresult, cuLaunchHostFunc_ptsz, CUstream, hStream, CUhostFn, fn, void *,
       userData)
...
DEF_FN(CUresult, cuEventElapsedTime, float *, pMilliseconds, CUevent, hStart,
       CUevent, hEnd)
#undef cuStreamWaitValue32
DEF_FN(CUresult, cuStreamWaitValue32, CUstream, stream, CUdeviceptr, addr,
       cuuint32_t, value, unsigned int, flags)
DEF_FN(CUresult, cuStreamWaitValue32_ptsz, CUstream, stream, CUdeviceptr, addr,
       cuuint32_t, value, unsigned int, flags)
#undef cuStreamWriteValue32
DEF_FN(CUresult, cuStreamWriteValue32, CUstream, stream, CUdeviceptr, addr,
       cuuint32_t, value, unsigned int, flags)
DEF_FN(CUresult, cuStreamWriteValue32_ptsz, CUstream, stream, CUdeviceptr, addr,
       cuuint32_t, value, unsigned int, flags)
#undef cuStreamWaitValue64
DEF_FN(CUresult, cuStreamWaitValue64, CUstream, stream, CUdeviceptr, addr,
       cuuint64_t, value, unsigned int, flags)
DEF_FN(CUresult, cuStreamWaitValue64_ptsz, CUstream, stream, CUdeviceptr, addr,
       cuuint64_t, value, unsigned int, flags)
#undef cuStreamWriteValue64
DEF_FN(CUresult, cuStreamWriteValue64, CUstream, stream, CUdeviceptr, addr,
       cuuint64_t, value, unsigned int, flags)
DEF_FN(CUresult, cuStreamWriteValue64_ptsz, CUstream, stream, CUdeviceptr, addr,
       cuuint64_t, value, unsigned int, flags)
#undef cuStreamBatchMemOp
DEF_FN(CUresult, cuStreamBatchMemOp, CUstream, stream, unsigned int, count,
       CUstreamBatchMemOpParams *, paramArray, unsigned int, flags)
DEF_FN(CUresult, cuStreamBatchMemOp_ptsz, CUstream, stream, unsigned int, count,
       CUstreamBatchMemOpParams *, paramArray, unsigned int, flags)
DEF_FN(CUresult, cuStreamCreate, CUstream *, phStream, unsigned int, Flags)
DEF_FN(CUresult, cuStreamCreateWithPriority, CUstream *, phStream, unsigned int,
       flags, int, priority)
...
DEF_FN(CUresult, cuStreamGetFlags_ptsz, CUstream, hStream, unsigned int *,
       flags)
DEF_FN(CUresult, cuStreamGetCtx, CUstream, hStream, CUcontext *, pctx)
DEF_FN(CUresult, cuStreamWaitEvent, CUstream, hStream, CUevent, hEvent,
       unsigned int, Flags)
DEF_FN(CUresult, cuStreamWaitEvent_ptsz, CUstream, hStream, CUevent, hEvent,
       unsigned int, Flags)
DEF_FN(CUresult, cuStreamAddCallback, CUstream, hStream, CUstreamCallback,
       callback, void *, userData, unsigned int, flags)
DEF_FN(CUresult, cuStreamAddCallback_ptsz, CUstream, hStream, CUstreamCallback,
       callback, void *, userData, unsigned int, flags)
...
DEF_FN(CUresult, cuStreamAttachMemAsync, CUstream, hStream, CUdeviceptr, dptr,
       size_t, length, unsigned int, flags)
DEF_FN(CUresult, cuStreamAttachMemAsync_ptsz, CUstream, hStream, CUdeviceptr,
       dptr, size_t, length, unsigned int, flags)
DEF_FN(CUresult, cuDeviceCanAccessPeer, int *, canAccessPeer, CUdevice, dev,
       CUdevice, peerDev)
DEF_FN(CUresult, cuCtxEnablePeerAccess, CUcontext, peerContext, unsigned int,
       Flags)
DEF_FN(CUresult, cuCtxDisablePeerAccess, CUcontext, peerContext)
DEF_FN(CUresult, cuIpcGetEventHandle, CUipcEventHandle *, pHandle, CUevent,
       event)
DEF_FN(CUresult, cuIpcOpenEventHandle, CUevent *, phEvent, CUipcEventHandle,
       handle)
DEF_FN(CUresult, cuIpcGetMemHandle, CUipcMemHandle *, pHandle, CUdeviceptr,
       dptr)
#undef cuIpcOpenMemHandle
DEF_FN(CUresult, cuIpcOpenMemHandle, CUdeviceptr *, pdptr, CUipcMemHandle,
...
DEF_FN(CUresult, cuGraphicsMapResources, unsigned int, count,
       CUgraphicsResource *, resources, CUstream, hStream)
DEF_FN(CUresult, cuGraphicsMapResources_ptsz, unsigned int, count,
       CUgraphicsResource *, resources, CUstream, hStream)
DEF_FN(CUresult, cuGraphicsUnmapResources, unsigned int, count,
       CUgraphicsResource *, resources, CUstream, hStream)
DEF_FN(CUresult, cuGraphicsUnmapResources_ptsz, unsigned int, count,
       CUgraphicsResource *, resources, CUstream, hStream)
DEF_FN(CUresult, cuGraphicsSubResourceGetMappedArray, CUarray *, pArray,
       CUgraphicsResource, resource, unsigned int, arrayIndex, unsigned int,
       mipLevel)
DEF_FN(CUresult, cuGraphicsResourceGetMappedMipmappedArray, CUmipmappedArray *,
       pMipmappedArray, CUgraphicsResource, resource)
#undef cuGraphicsResourceGetMappedPointer
DEF_FN(CUresult, cuGraphicsResourceGetMappedPointer, CUdeviceptr *, pDevPtr,
       size_t *, pSize, CUgraphicsResource, resource)
#undef cuGraphicsResourceSetMapFlags
DEF_FN(CUresult, cuGraphicsResourceSetMapFlags, CUgraphicsResource, resource,
       unsigned int, flags)
// DEF_FN(CUresult, cuGetExportTable, const void**, ppExportTable, const
// CUuuid*, pExportTableId)

// This function returns an array of 8 function pointers to hidden functions
// inside libcuda.so
/*CUresult cuGetExportTable(const void** ppExportTable, const CUuuid*
pExportTableId)
{
    enum clnt_stat retval;
    char *uuid = NULL;
    ...
    LOGE(LOG_DEBUG, "[rpc] %s(%p, %s) = %d, result = %p", __FUNCTION__,
ppExportTable, idstr, result.err, orig_table);
...
DEF_FN(CUresult, cuMemRangeGetAttributes, void **, data, size_t *, dataSizes,
       CUmem_range_attribute *, attributes, size_t, numAttributes, CUdeviceptr,
       devPtr, size_t, count)
CUresult cuGetErrorString(CUresult error, const char **pStr)
{
    ...
    LOGE(LOG_DEBUG, "[rpc] %s(%d) = %d, result %s", __FUNCTION__, error,
         result.err, result.str_result_u.str);
    if (retval != RPC_SUCCESS) {
        fprintf(stderr, "[rpc] %s failed.", __FUNCTION__);
        return CUDA_ERROR_UNKNOWN;
    }
...
DEF_FN(CUresult, cuGraphAddKernelNode, CUgraphNode *, phGraphNode, CUgraph,
       hGraph, const CUgraphNode *, dependencies, size_t, numDependencies,
       const CUDA_KERNEL_NODE_PARAMS *, nodeParams)
#undef cuGraphKernelNodeGetParams
DEF_FN(CUresult, cuGraphKernelNodeGetParams, CUgraphNode, hNode,
       CUDA_KERNEL_NODE_PARAMS *, nodeParams)
#undef cuGraphKernelNodeSetParams
DEF_FN(CUresult, cuGraphKernelNodeSetParams, CUgraphNode, hNode,
       const CUDA_KERNEL_NODE_PARAMS *, nodeParams)
DEF_FN(CUresult, cuGraphAddMemcpyNode, CUgraphNode *, phGraphNode, CUgraph,
       hGraph, const CUgraphNode *, dependencies, size_t, numDependencies,
       const CUDA_MEMCPY3D *, copyParams, CUcontext, ctx)
DEF_FN(CUresult, cuGraphMemcpyNodeGetParams, CUgraphNode, hNode,
       CUDA_MEMCPY3D *, nodeParams)
DEF_FN(CUresult, cuGraphMemcpyNodeSetParams, CUgraphNode, hNode,
       const CUDA_MEMCPY3D *, nodeParams)
DEF_FN(CUresult, cuGraphAddMemsetNode, CUgraphNode *, phGraphNode, CUgraph,
       hGraph, const CUgraphNode *, dependencies, size_t, numDependencies,
       const CUDA_MEMSET_NODE_PARAMS *, memsetParams, CUcontext, ctx)
DEF_FN(CUresult, cuGraphMemsetNodeGetParams, CUgraphNode, hNode,
       CUDA_MEMSET_NODE_PARAMS *, nodeParams)
DEF_FN(CUresult, cuGraphMemsetNodeSetParams, CUgraphNode, hNode,
       const CUDA_MEMSET_NODE_PARAMS *, nodeParams)
DEF_FN(CUresult, cuGraphAddHostNode, CUgraphNode *, phGraphNode, CUgraph,
       hGraph, const CUgraphNode *, dependencies, size_t, numDependencies,
       const CUDA_HOST_NODE_PARAMS *, nodeParams)
DEF_FN(CUresult, cuGraphHostNodeGetParams, CUgraphNode, hNode,
       CUDA_HOST_NODE_PARAMS *, nodeParams)
DEF_FN(CUresult, cuGraphHostNodeSetParams, CUgraphNode, hNode,
       const CUDA_HOST_NODE_PARAMS *, nodeParams)
DEF_FN(CUresult, cuGraphAddChildGraphNode, CUgraphNode *, phGraphNode, CUgraph,
       hGraph, const CUgraphNode *, dependencies, size_t, numDependencies,
       CUgraph, childGraph)
DEF_FN(CUresult, cuGraphChildGraphNodeGetGraph, CUgraphNode, hNode, CUgraph *,
       phGraph)
DEF_FN(CUresult, cuGraphAddEmptyNode, CUgraphNode *, phGraphNode, CUgraph,
       hGraph, const CUgraphNode *, dependencies, size_t, numDependencies)
DEF_FN(CUresult, cuGraphClone, CUgraph *, phGraphClone, CUgraph, originalGraph)
DEF_FN(CUresult, cuGraphNodeFindInClone, CUgraphNode *, phNode, CUgraphNode,
       hOriginalNode, CUgraph, hClonedGraph)
DEF_FN(CUresult, cuGraphNodeGetType, CUgraphNode, hNode, CUgraphNodeType *,
       type)
DEF_FN(CUresult, cuGraphGetNodes, CUgraph, hGraph, CUgraphNode *, nodes,
       size_t *, numNodes)
...
DEF_FN(CUresult, cuGraphNodeGetDependentNodes, CUgraphNode, hNode,
       CUgraphNode *, dependentNodes, size_t *, numDependentNodes)
DEF_FN(CUresult, cuGraphAddDependencies, CUgraph, hGraph, const CUgraphNode *,
       from, const CUgraphNode *, to, size_t, numDependencies)
...
DEF_FN(CUresult, cuGraphInstantiate, CUgraphExec *, phGraphExec, CUgraph,
       hGraph, unsigned long long, flags)
#else
DEF_FN(CUresult, cuGraphInstantiate, CUgraphExec *, phGraphExec, CUgraph,
       hGraph, CUgraphNode *, phErrorNode, char *, logBuffer, size_t,
       bufferSize)
#endif
...
DEF_FN(CUresult, cuStreamBeginCapture, CUstream, hStream, CUstreamCaptureMode,
       mode)
...
DEF_FN(CUresult, cuStreamIsCapturing, CUstream, hStream,
       CUstreamCaptureStatus *, captureStatus)
DEF_FN(CUresult, cuStreamIsCapturing_ptsz, CUstream, hStream,
       CUstreamCaptureStatus *, captureStatus)
DEF_FN(CUresult, cuThreadExchangeStreamCaptureMode, CUstreamCaptureMode *, mode)
#undef cuStreamGetCaptureInfo
DEF_FN(CUresult, cuStreamGetCaptureInfo, CUstream, hStream,
       CUstreamCaptureStatus *, captureStatus_out, cuuint64_t *, id_out,
       CUgraph *.graph_out, const CUgraphNode **, dependencies_out, size_t *,
       numDependencies_out)
DEF_FN(CUresult, cuStreamGetCaptureInfo_ptsz, CUstream, hStream,
       CUstreamCaptureStatus *, captureStatus, cuuint64_t *, id)
#undef cuGraphExecKernelNodeSetParams
DEF_FN(CUresult, cuGraphExecKernelNodeSetParams, CUgraphExec, hGraphExec,
                          ...
                          CUdriverProcAddressQueryResult *symbolStatus)
{
    enum clnt_stat retval;
    ptr_result result;
    LOGE(LOG_DEBUG, "%s(%s, %d, %llx)", __FUNCTION__, symbol, cudaVersion,
         flags);
    ...
    *pfn = elf2_symbol_address(symbol);
    ...
    // Pytorch uses the 11.3 API of this function which does not have the
    // symbolStatus parameter Because we do not support API versioning yet and
    // to avoid segfaults, we ignore this parameter for now.
                                       ...
                                       CUmemAllocationGranularity_flags option)
{
    ...
    retval = rpc_cumemgetallocationgranularity_1(rpc_prop, (int)option, &result,
                                                 clnt);
    LOGE(LOG_DEBUG, "[rpc] %s(%p, %#x) = %d, result %zx", __FUNCTION__, prop,
         option, result.err, result.sz_result_u.data);
    if (retval != RPC_SUCCESS) {
        LOGE(LOG_ERROR, "[rpc] %s failed.", __FUNCTION__);
        return CUDA_ERROR_UNKNOWN;
    }
