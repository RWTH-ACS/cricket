...
DEF_FN(cudaError_t, cudaFuncSetAttribute, const void*, func, struct cudaFuncAttribute, attr, int,  value)
DEF_FN(cudaError_t, cudaFuncSetCacheConfig, const void*, func, enum cudaFuncCache, cacheConfig)
DEF_FN(cudaError_t, cudaFuncSetSharedMemConfig, const void*, func, struct cudaSharedMemConfig, config)
...
DEF_FN(cudaError_t, cudaLaunchCooperativeKernelMultiDevice, cudaLaunchParams*, struct launchParamsList, unsigned int,  numDevices, unsigned int,  flags)
